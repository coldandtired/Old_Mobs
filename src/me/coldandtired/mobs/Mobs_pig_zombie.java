	...
	public void setup(MemorySection ms, Map<String, Object> unique, String spawn_reason)
	{
		...
		if (unique != null)
		{
			if (unique.containsKey("general"))
			{
				...
				if (general.containsKey("angry")) if (Utils.get_random(general.get("angry"))) angerLevel = 400;
			}
		...
		else
		{
			...
			if (ms.contains("general.angry")) if (Utils.get_random(ms.get("general.angry"))) angerLevel = 400;
