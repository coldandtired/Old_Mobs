...
public class Mobs_giant extends net.minecraft.server.EntityGiantZombie
{
	private int hp = 100;
	...
	public void setup(MemorySection general, Map<String, Object> unique, String spawn_reason)
	{
		...
		hp = Utils.set_int_property(100, general, u_general, "hp");
		damage = Utils.set_int_property(50, general, u_general, "damages");
