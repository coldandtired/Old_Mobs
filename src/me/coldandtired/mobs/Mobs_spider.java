...
public class Mobs_spider extends net.minecraft.server.EntitySpider
{
	private int hp = 16;
	...
	public Mobs_spider(World world) 
	{
		super(world);
	}
	...
	public void setup(MemorySection general, Map<String, Object> unique, String spawn_reason)
	{
		...
		hp = Utils.set_int_property(16, general, u_general, "hp");
		damage = Utils.set_int_property(2, general, u_general, "damages");
